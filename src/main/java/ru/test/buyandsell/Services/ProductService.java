...
import ru.test.buyandsell.Repositories.ProductRepository;
...
public class ProductService {
    ...
    public void saveProduct(Principal principal, Product product, MultipartFile file1, MultipartFile file2, MultipartFile file3) throws IOException {
        ...
        productFromDB.setPreviewImageId(productFromDB.getImages().get(0).getId() );     //Сохраняем в базу данных для получения превьюшнего id для image
